...
export class AudioManager {
    constructor() {
        ...
        Object.defineProperty(this, "bgmOscillators", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "bgmGain", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "bgmLFO", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "bgmPlaying", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
    ...
    playSound(soundId) {
        ...
        if (soundParams.frequencySlide) {
            oscillator.frequency.exponentialRampToValueAtTime(soundParams.frequencySlide, now + soundParams.duration);
        }
        // 音量包络
