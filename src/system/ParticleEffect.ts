...
export class Particle {
   ...
   * 获取归一化的生命值 (0-1)
   */
  public getNormalizedLife(): number {
...
export class ParticleEffect {
   ...
   * 从对象池获取空闲粒子
   */
  private getPoolParticle(): PooledParticle | null {
   ...
   * @param lines 消除行数
   */
  public spawnForLines(x: number, y: number, color: string, lines: number): void {
    switch (lines) {
      case 1:
        // 1 行：20-30 个粒子，小范围
