...
describe('BlockVisual', () => {
  ...
  describe('基础渲染', () => {
    it('应该渲染所有 7 种方块类型', () => {
      pieceTypes.forEach((type) => {
        const { container, unmount } = render(
          <BlockVisual pieceType={type} size={24} />
        );
    ...
    it('应该使用正确的尺寸渲染', () => {
      const { container } = render(<BlockVisual pieceType="I" size={32} />);
      const blockVisual = container.querySelector('.block-visual') as HTMLElement;
    ...
    it('应该使用默认尺寸 24px', () => {
      const { container } = render(<BlockVisual pieceType="O" />);
      const blockVisual = container.querySelector('.block-visual') as HTMLElement;
  ...
  describe('方块形状', () => {
    it('I-方块应该渲染 4x4 网格', () => {
      const { container } = render(<BlockVisual pieceType="I" size={40} />);
      const grid = container.querySelector('.block-grid') as HTMLElement;
    ...
    it('O-方块应该渲染 2x2 网格', () => {
      const { container } = render(<BlockVisual pieceType="O" size={40} />);
      const grid = container.querySelector('.block-grid') as HTMLElement;
    ...
    it('T-方块应该渲染 3x3 网格', () => {
      const { container } = render(<BlockVisual pieceType="T" size={30} />);
      const grid = container.querySelector('.block-grid') as HTMLElement;
    ...
    it('每个方块应该有正确数量的单元格', () => {
      pieceTypes.forEach((type) => {
        const shape = GAME_CONFIG.SHAPES[type as keyof typeof GAME_CONFIG.SHAPES];
        const gridSize = shape.length;
        
        const { container } = render(<BlockVisual pieceType={type} size={gridSize * 10} />);
  ...
  describe('方块颜色', () => {
    it('I-方块应该使用青色', () => {
      const { container } = render(<BlockVisual pieceType="I" />);
      const filledCell = container.querySelector('.block-cell-filled') as HTMLElement;
    ...
    it('T-方块应该使用兰花紫', () => {
      const { container } = render(<BlockVisual pieceType="T" />);
      const filledCell = container.querySelector('.block-cell-filled') as HTMLElement;
    ...
    it('S-方块应该使用绿色', () => {
      const { container } = render(<BlockVisual pieceType="S" />);
      const filledCell = container.querySelector('.block-cell-filled') as HTMLElement;
    ...
    it('Z-方块应该使用红色', () => {
      const { container } = render(<BlockVisual pieceType="Z" />);
      const filledCell = container.querySelector('.block-cell-filled') as HTMLElement;
    ...
    it('L-方块应该使用深橙色', () => {
      const { container } = render(<BlockVisual pieceType="L" />);
      const filledCell = container.querySelector('.block-cell-filled') as HTMLElement;
    ...
    it('J-方块应该使用宝蓝色', () => {
      const { container } = render(<BlockVisual pieceType="J" />);
      const filledCell = container.querySelector('.block-cell-filled') as HTMLElement;
  ...
  describe('边框和阴影', () => {
    ...
    it('showBorder=false 时应该隐藏边框', () => {
      const { container } = render(
        <BlockVisual pieceType="I" showBorder={false} />
      );
      const filledCell = container.querySelector('.block-cell-filled') as HTMLElement;
    ...
    it('showShadow=false 时应该隐藏阴影', () => {
      const { container } = render(
        <BlockVisual pieceType="I" showShadow={false} />
      );
      const filledCell = container.querySelector('.block-cell-filled') as HTMLElement;
  ...
  describe('自定义类名', () => {
    it('应该应用自定义类名', () => {
      const { container } = render(
        <BlockVisual pieceType="I" className="custom-class" />
      );
  ...
  describe('未知方块类型', () => {
    it('未知类型应该显示占位符', () => {
      const { container } = render(
        <BlockVisual pieceType="UNKNOWN" size={32} />
      );
  ...
  describe('性能优化', () => {
    it('应该快速渲染所有方块类型', () => {
      ...
      pieceTypes.forEach((type) => {
        render(<BlockVisual pieceType={type} />);
      });
