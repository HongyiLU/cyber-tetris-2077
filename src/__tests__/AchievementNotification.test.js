...
describe('AchievementNotification', () => {
    ...
    it('should not render when achievement is null', () => {
        const { container } = render(_jsx(AchievementNotification, { achievement: null, visible: true, onClose: mockOnClose }));
        expect(container.firstChild).toBeNull();
    });
    it('should not render when visible is false', () => {
        const { container } = render(_jsx(AchievementNotification, { achievement: mockAchievement, visible: false, onClose: mockOnClose }));
        expect(container.firstChild).toBeNull();
    });
    it('should render achievement information when visible', () => {
        render(_jsx(AchievementNotification, { achievement: mockAchievement, visible: true, onClose: mockOnClose }));
    ...
    it('should start with slide-in animation', () => {
        const { container } = render(_jsx(AchievementNotification, { achievement: mockAchievement, visible: true, onClose: mockOnClose }));
    ...
    it('should clear timer on unmount', () => {
        const { unmount } = render(_jsx(AchievementNotification, { achievement: mockAchievement, visible: true, onClose: mockOnClose }));
    ...
    it('should use default icon if not provided', () => {
        ...
        render(_jsx(AchievementNotification, { achievement: achievementWithoutIcon, visible: true, onClose: mockOnClose }));
    ...
    it('should show custom icon when provided', () => {
        ...
        render(_jsx(AchievementNotification, { achievement: achievementWithCustomIcon, visible: true, onClose: mockOnClose }));
