...
describe('Card Component', () => {
  ...
  describe('稀有度显示', () => {
    ...
    it('应该正确显示传说稀有度', () => {
      render(<Card card={legendaryCard} />);
    ...
    it('传说卡牌应该有发光动画类名', () => {
      const { container } = render(<Card card={legendaryCard} />);
  ...
  describe('尺寸变体', () => {
    it('应该渲染 small 尺寸', () => {
      const { container } = render(<Card card={testCard} size="small" />);
      const cardElement = container.querySelector('.cyber-card--small');
      expect(cardElement).toBeInTheDocument();
    });

    it('应该渲染 medium 尺寸', () => {
      const { container } = render(<Card card={testCard} size="medium" />);
      const cardElement = container.querySelector('.cyber-card--medium');
      expect(cardElement).toBeInTheDocument();
    });

    it('应该渲染 large 尺寸', () => {
      const { container } = render(<Card card={testCard} size="large" />);
  ...
  describe('可点击功能', () => {
    ...
    it('clickable=true 时点击应该触发回调', () => {
      ...
      render(<Card card={testCard} clickable={true} onClick={handleClick} />);
      const cardElement = screen.getByRole('button');
    ...
    it('clickable=true 时应该有指针样式', () => {
      const { container } = render(<Card card={testCard} clickable={true} />);
  ...
  describe('自定义样式', () => {
    it('应该应用自定义 className', () => {
      const { container } = render(
        <Card card={testCard} className="custom-class" />
      );
    ...
    it('应该应用自定义 style', () => {
      ...
      const { container } = render(
        <Card card={testCard} style={customStyle} />
      );
      const cardElement = container.querySelector('.cyber-card');
  ...
  describe('边框和阴影', () => {
    ...
    it('showBorder=false 时应该隐藏边框', () => {
      const { container } = render(<Card card={testCard} showBorder={false} />);
      const cardElement = container.querySelector('.cyber-card');
    ...
    it('showShadow=false 时应该隐藏阴影', () => {
      const { container } = render(<Card card={testCard} showShadow={false} />);
      const cardElement = container.querySelector('.cyber-card');
