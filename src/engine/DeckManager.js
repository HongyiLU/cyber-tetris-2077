...
export class DeckManager {
    constructor(config = {}) {
        ...
        Object.defineProperty(this, "activeDeckId", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "deckConfig", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "deckConfigStorageKey", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 'tetris_deck_config_v1'
        });
        // 牌堆模式：当前抽取池（会减少）
        Object.defineProperty(this, "currentDrawPool", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        ...
        Object.defineProperty(this, "lastStorageError", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
         ...
         */
        Object.defineProperty(this, "PRESET_DECKS", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: [
         ...
         * 默认卡组配置（每种方块 1 个）
         */
        Object.defineProperty(this, "DEFAULT_DECK_CONFIG", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: {
     ...
     */
    createDeck(name, cards = [], description) {
        // 生成唯一 ID
     ...
     * @returns 导入的卡组对象
     */
    importDeck(jsonString, rename = false) {
        try {
     ...
     */
    downloadBackup(filename = 'cyber-blocks-backup.json') {
     ...
     */
    saveAsTemplate(deckId, templateName) {
        const deck = this.decks.get(deckId);
        if (!deck) {
            throw new Error(`卡组不存在：${deckId}`);
        }
     ...
     * @returns 从模板创建的卡组
     */
    loadTemplate(templateId, newDeckName) {
